...
<%@include file='public_header.jsp' %>
        ...
        <form role="form"  action="check_user_login.jsp" method="post">
           <div class="form-group">
                            <label for="email" class="col-md-2">Email</label>
                            <div class="col-md-10">
                                <input type="text" placeholder="Enter Email" required  class="form-control" name="email" id="email">
                            </div>
                        </div>
            <br>
            <br>
          <div class="form-group">
            ...
            <br>
                 <div class="col-lg-offset-2 col-lg-10">
                     ...
                     <a href="recover_userpass.jsp" class="txt-black">Forgot Password?</a>
                     <br>
                     <br>
                     <br>
                 </div>
